...
string Prefix, LogFilename, OPath, Usage, 
  ...
  n_Filename, dictionary_Filename, sourceWord2Vec_Filename, targetWord2Vec_Filename, tmat_Filename;
...
{ 
  ...
  tTable.initWord2Vec(word2vec, useWord2Vec);
#endif
...
int main(int argc, char* argv[])
{
  ...
  getGlobalParSet().insert(new Parameter<string>("tmat",ParameterChangedFlag,"translation matrix file name",tmat_Filename,PARLEV_INPUT));
